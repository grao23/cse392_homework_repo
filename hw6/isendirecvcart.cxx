...
/**** your code here ****/
/**** your code here ****/
  MPI_Cart_shift(cart_comm, 0,1,&predecessor, &successor); 
  ...
  // data to the left
  MPI_Isend(&mydata,1,MPI_DOUBLE, predecessor,0, comm, &(requests[2]) );
  MPI_Irecv(&(neighbor_data[1]),1,MPI_DOUBLE, successor,0, comm, &(requests[3]) );
/**** your code here ****/

  // now vertical
  MPI_Cart_shift
    ( cart_comm,
      1,1, &predecessor, &successor
/**** your code here ****/
      );
  border_count += 
    ( predecessor==MPI_PROC_NULL ? 1 : 0 )
...
/**** your code here ****/
  //data up
  MPI_Isend(&mydata,1,MPI_DOUBLE, successor,0, comm, &(requests[4]) );
  MPI_Irecv(&(neighbor_data[2]),1,MPI_DOUBLE, predecessor,0, comm, &(requests[5]) );

  //data down
  MPI_Isend(&mydata,1,MPI_DOUBLE, predecessor,0, comm, &(requests[6]) );
  MPI_Irecv(&(neighbor_data[3]),1,MPI_DOUBLE, successor,0, comm, &(requests[7]) );
  //
