...
/**** your code here ****/
  ...
  if (procno==0)
    ...
    MPI_Gather(&my_number_of_elements,1, MPI_INT,
	       size_buffer.data(), 1, MPI_INT, 0, comm); 
...
/**** your code here ****/
  ...
  if (procno==0)
    ...
    MPI_Gather(&my_first_index,1, MPI_INT,
               displ_buffer.data(), 1, MPI_INT, 0, comm);
   ...
   */
  MPI_Gatherv(my_elements.data(), my_number_of_elements,MPI_INT, gather_buffer.data(),
		size_buffer.data(), displ_buffer.data(), MPI_INT, 0, comm);
